...
date: 2017-10-18 (ASA Oregon Chapter Fall 2017 meeting) <br><br> Slides available at <http://bit.ly/asa-ismay17> <br> Free Reproducible Textbook at <http://ModernDive.com>
output: 
...
- Lead more workshops on using the `infer` package to extend student knowledge of the `tidyverse`, R, and statistics
