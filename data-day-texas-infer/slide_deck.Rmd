...
Error in chisq.test(data = car_stop, formula = vehicle_type ~ stop_type) : 
  unused arguments (data = car_stop, formula = vehicle_type ~ stop_type)
```
