...
date: 2018-03-02 <br><br> Slides available at <http://bit.ly/osu-ismay18>
output: 
...
- Generalize `infer` functions so it is useful to practioners as well as students
- Rewrite the inference part of the ModernDive book
- Lead more workshops on using the `infer` package to extend knowledge of the `tidyverse`, R, and statistics like [this one](https://symposium.nestat.org/short-courses.html#infer)
