...
`r gif_link("https://infer-dev.netlify.com", "images/infer-gnome.png", 400)`
...
```{r}
library(infer)
mythbusters_yawn <- read_rds(url("http://bit.ly/evals-rds"))
mythbusters_yawn %>% 
...
- An HTML report version of the slides is [here]()
- Download and extract the ZIP file [here]()
    - Click on `ismay_bakeoff.Rproj` to open RStudio

--

- If I wasn't using R Markdown, what would I do if there was a mistake in `bakeoff.csv`?
